...
const ViewDetails = () => {
    ...
    useEffect(() => {
        fetch(`https://salty-brook-20691.herokuapp.com/cars/${id}`)
            .then((res) => res.json())
            .then((data) => {
                setProduct(data);
            });
    ...
    const handlePurchase = (e) => {
        ...
        fetch("https://salty-brook-20691.herokuapp.com/order", {
            method: "POST",
            headers: {
    ...
    return (
        ...
        <div>
            ...
            <div className="container mx-auto my-16">
                <h1 className="text-5xl my-7 text-gray-700 font-bold text-center">
                    Purchase product
                </h1>
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 xl:gap-28">
                    ...
                    <div className="lg:col-span-7 flex flex-col justify-center">
                        ...
                        <h2 className="text-xl my-1">
                            <span className="font-medium">Fule: </span>
                            <span className="text-yellow-700">
                                {product.Fuel}
                            </span>
                        </h2>
